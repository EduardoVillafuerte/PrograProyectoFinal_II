...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                try {
                    java.awt.Desktop.getDesktop().browse(new java.net.URI("https://www.instagram.com/theplazahotel/?hl=es"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 0, 530, 740));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        int rol = -1;
        try{
            ResultSet rs = hotel.autenticarUsuario(user,pass);
            if (rs.next()) {
                rol = rs.getInt("rol");
            }
            switch (rol) {
                ...
                case 1 -> {
                    ...
                    new JFrameCliente(hotel,rs.getString("user")).setVisible(true);
                    this.dispose();
                }
                default -> JOptionPane.showMessageDialog(null, "Usuario o contraseña incorrecta");
            }
        }catch(Exception e){
            System.out.println("No se pudo acceder "+ e.getMessage());}
